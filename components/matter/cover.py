...
DISCOVERY_SCHEMAS = [
    MatterDiscoverySchema(
        ...
        # Some devices (e.g. Shelly 2PM Gen4 in lift-only mode) report                                                                                                  
        # CurrentPositionTiltPercent100ths as present but null instead of                                                                                               
        # omitting it entirely. Without this, no cover schema matches at all.                                                                                           
